    ...
    <div className="min-h-screen bg-[#0E0E13] flex items-center justify-center px-6">
      ...
      <div className="relative z-10 max-w-md w-full">
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-black text-[#F4F4F7] mt-6 mb-2">Reset your password</h1>
          <p className="text-[#7E7E8E] text-sm">We&apos;ll email you a link to set a new one</p>
        </div>
