    ...
    <div className="min-h-screen bg-[#060609]">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 pt-10 pb-20">
                ...
                <>
                  ...
                  <div className="relative mt-2">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="text-[10px] font-bold text-[#A6A6B4] bg-[#0D0C14]/80 px-3 py-1 rounded-full">Unlock to see full version</span>
                    </div>
                  </div>
                </>
              ) : (
        ...
        <div className="gradient-border-card rounded-2xl p-6 mb-6">
          ...
          {payError && (
            <div className="mb-4 rounded-xl px-4 py-3 text-xs text-[#FB7185]" style={{ background: 'rgba(251, 113, 133, 0.10)', border: '1px solid rgba(251, 113, 133, 0.25)' }}>
              {payError}
            </div>
          )}
