      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 pt-10 pb-20">
        ...
        {report && (
          <div className="space-y-5">
            {/* Risk dial */}
            <div className="rounded-2xl p-6 text-center" style={{ background: '#0D0C14', border: `1px solid ${rc}55` }}>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {report.at_risk_tasks && report.at_risk_tasks.length > 0 && (
                <div className="rounded-2xl p-5" style={{ background: '#0D0C14', border: '1px solid rgba(255,255,255,0.08)' }}>
                  <p className="text-[#FB7185] text-[10px] font-bold uppercase tracking-wider mb-2">⚠️ AI is already doing</p>
