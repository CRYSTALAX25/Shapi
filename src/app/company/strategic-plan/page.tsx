        ...
        {!loading && engagement && (
          <>
            ...
            <Link
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(56, 189, 248, 0.14), rgba(56, 189, 248, 0.10))',
            ...
            >
              <div className="flex items-center gap-3.5">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] font-bold uppercase tracking-wider mb-0.5" style={{ color: '#38BDF8' }}>Included with your engagement</p>
                ...
                <span className="flex-shrink-0 text-[#38BDF8] text-xs font-black whitespace-nowrap hidden sm:inline">Book session →</span>
              </div>
            </Link>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <textarea
                  ...
                  rows={4}
                  disabled={isLocked}
                  className="w-full rounded-lg px-3 py-2.5 text-sm text-[#F4F4F7] placeholder-[#7E7E8E] outline-none focus:border-[#38BDF8]/50"
            ...
            <div className="mt-6 rounded-2xl p-5 flex items-center justify-between" style={cardStyle}>
              ...
              <button
                ...
                style={{ background: isLocked ? 'rgba(52,211,153,0.18)' : 'linear-gradient(135deg, #38BDF8, #34D399)', color: isLocked ? '#34D399' : 'white' }}
              >
...
function DnaOutput({ data }: { data: Record<string, unknown> }) {
  ...
  return (
    <div className="mt-4 space-y-4">
      ...
      <div className="rounded-2xl p-5" style={{ background: 'rgba(56, 189, 248, 0.05)', border: '1px solid rgba(56, 189, 248, 0.20)' }}>
        ...
        {data.headline_archetype && (
          <p className="text-[#38BDF8] text-sm font-bold mt-4 pt-4 border-t border-white/[0.06] text-center md:text-left">
...
const BUCKETS = [
  ...
  { key: 'augment',  label: 'Augment',  color: '#38BDF8', bg: 'rgba(56, 189, 248, 0.10)', border: 'rgba(56, 189, 248, 0.30)' },
  { key: 'reskill',  label: 'Reskill',  color: '#FBBF24', bg: 'rgba(251,191,36,0.10)',  border: 'rgba(251,191,36,0.30)' },
  { key: 'redeploy', label: 'Redeploy', color: '#38BDF8', bg: 'rgba(56, 189, 248, 0.10)', border: 'rgba(56, 189, 248, 0.30)' },
  { key: 'protect',  label: 'Protect',  color: '#34D399', bg: 'rgba(52,211,153,0.10)',  border: 'rgba(52,211,153,0.30)' },
  { key: 'automate', label: '✦ Automate', color: '#38BDF8', bg: 'rgba(56, 189, 248, 0.12)', border: 'rgba(56, 189, 248, 0.35)' },
] as const
...
function WorkforcePlanOutput({ data }: { data: Record<string, unknown> }) {
  ...
  return (
    <div className="mt-4 space-y-3">
      {data.headline_call && (
        <p className="text-[#38BDF8] text-sm font-bold">{String(data.headline_call)}</p>
      )}
      {horizons.map(h => {
          ...
          <div key={h} className="rounded-xl p-3.5" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            {scenarios.length > 0 && (
              <div className="mt-3 pt-3 border-t border-white/[0.05]">
                ...
                {scenarios.map((s, i) => (
                  <div key={i} className="mt-1.5 pl-2 border-l-2" style={{ borderColor: '#38BDF8' }}>
...
function PeopleOutlayOutput({ data }: { data: Record<string, unknown> }) {
  ...
  const tierColour = (t: string | null | undefined) => {
    ...
    if (t === 'basic') return { bg: 'rgba(56, 189, 248, 0.15)', fg: '#38BDF8', label: 'Verified' }
    return { bg: 'rgba(255,255,255,0.06)', fg: '#A6A6B4', label: 'Unverified' }
  }

  const typeChip = (t: string | undefined) => {
    if (t === 'new_hire') return { bg: 'rgba(56, 189, 248, 0.14)', fg: '#38BDF8', label: 'New hire' }
    if (t === 'reskill') return { bg: 'rgba(251,191,36,0.14)', fg: '#FBBF24', label: 'Reskill' }
    if (t === 'redeploy') return { bg: 'rgba(56, 189, 248, 0.14)', fg: '#38BDF8', label: 'Redeploy' }
  ...
  return (
    <div className="mt-4 space-y-3">
      {headline && (
        <p className="text-[#38BDF8] text-sm font-bold">{headline}</p>
      )}
            ...
            {Array.isArray(g.must_have_skills) && g.must_have_skills.length > 0 && (
              <div className="flex flex-wrap gap-1.5 mb-2.5">
                {g.must_have_skills.slice(0, 6).map((s, j) => (
                  <span key={j} className="text-[9px] font-medium px-2 py-0.5 rounded" style={{ background: 'rgba(56, 189, 248, 0.10)', color: '#38BDF8' }}>{s}</span>
                ))}
              </div>
            )}
                      ...
                      >
                        <div className="flex items-center gap-2.5">
                          ...
                          <div className="flex-shrink-0 text-right">
                            <p className="text-[#38BDF8] font-black text-sm">{c.match_score}<span className="text-[9px]">%</span></p>
...
function PlaybookOutput({ data }: { data: Record<string, unknown> }) {
  ...
  return (
    <div className="mt-4 space-y-3">
      ...
      {milestones.length > 0 && (
        <div className="rounded-2xl p-4" style={{ background: 'linear-gradient(135deg, rgba(52,211,153,0.10), rgba(56, 189, 248, 0.06))', border: '1px solid rgba(52,211,153,0.30)' }}>
          ...
          <div className="grid grid-cols-3 gap-2">
            {([
              ...
              { label: 'Day 31–60', items: bucketed.d60, accent: '#38BDF8' },
              { label: 'Day 61–90', items: bucketed.d90, accent: '#38BDF8' },
            ]).map(slot => (
      ...
      <div className="grid md:grid-cols-2 gap-3">
        ...
        {Object.keys(hiring).length > 0 && (
          <div className="rounded-2xl p-4" style={{ background: 'rgba(56, 189, 248, 0.08)', border: '1px solid rgba(56, 189, 248, 0.25)' }}>
            <div className="flex items-center gap-2 mb-2.5">
              ...
              <p className="text-[10px] font-bold uppercase tracking-wider" style={{ color: '#38BDF8' }}>Hiring plan</p>
            </div>
              ...
              <div className="mb-2">
                ...
                <div className="flex flex-wrap gap-1">
                  {(hiring.channels as string[]).map((c, i) => (
                    <span key={i} className="text-[10px] px-2 py-0.5 rounded-full" style={{ background: 'rgba(56, 189, 248, 0.14)', color: '#38BDF8' }}>{c}</span>
                  ))}
                </div>
              </div>
            )}
        ...
        {Object.keys(outplacement).length > 0 && (
          <div className="rounded-2xl p-4" style={{ background: 'rgba(56, 189, 248, 0.08)', border: '1px solid rgba(56, 189, 248, 0.25)' }}>
            <div className="flex items-center gap-2 mb-2.5">
              <span className="text-base">🛟</span>
              <p className="text-[10px] font-bold uppercase tracking-wider" style={{ color: '#38BDF8' }}>Outplacement</p>
            </div>
              ...
              <div className="mb-2.5">
                ...
                <div className="flex flex-wrap gap-1">
                  {(outplacement.vendor_options as string[]).map((v, i) => (
                    <span key={i} className="text-[10px] px-2 py-0.5 rounded-full" style={{ background: 'rgba(56, 189, 248, 0.14)', color: '#38BDF8' }}>{v}</span>
                  ))}
                </div>
              </div>
            )}
      ...
      <div className="rounded-2xl p-4" style={{ background: 'linear-gradient(135deg, rgba(56, 189, 248, 0.10), rgba(56, 189, 248, 0.06))', border: '1px dashed rgba(56, 189, 248, 0.40)' }}>
        <div className="flex items-start gap-3">
          <div className="flex-shrink-0 w-10 h-10 rounded-xl flex items-center justify-center text-lg" style={{ background: 'rgba(56, 189, 248, 0.18)' }}>🧭</div>
          <div className="flex-1">
            <div className="flex items-center justify-between gap-2 flex-wrap">
              <p className="text-[#38BDF8] font-bold text-sm">Per-employee HR portal — now live</p>
              <Link href="/company/people" className="text-[11px] font-black px-3 py-1.5 rounded-full text-white" style={{ background: 'linear-gradient(135deg,#38BDF8, #34D399)' }}>
                Open People →
              </Link>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-1.5 mt-2">
              {[
                ...
                <div key={i} className="rounded-lg p-2" style={{ background: 'rgba(56, 189, 248, 0.06)', border: '1px solid rgba(56, 189, 248, 0.18)' }}>
