              ...
              <div className="space-y-2">
                {roles.map((r, i) => (
                  <div key={i} className="flex gap-2">
                    ...
                    {roles.length > 1 && (
                      <button onClick={() => removeRole(i)} className="text-[#7E7E8E] hover:text-[#FB7185] text-sm px-2">✕</button>
                    )}
                  </div>
                ))}
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl p-5" style={cardStyle}>
              ...
              <div className="grid grid-cols-3 gap-2 mb-3">
                <div className="rounded-xl p-3" style={{ background: 'rgba(251, 113, 133, 0.10)', border: '1px solid rgba(251, 113, 133, 0.25)' }}>
                  <p className="text-[10px] text-[#A6A6B4]">High risk</p>
                  <p className="text-xl font-black" style={{ color: '#FB7185' }}>{report.ai_risk_heatmap.high_risk_count}</p>
                </div>
