...
const PERSON_STATUS_STYLE: Record<string, { bg: string; color: string; label: string }> = {
  ...
  on_leave:    { bg: 'rgba(124,147,245,0.14)', color: ACCENT,    label: 'On leave' },
  separating:  { bg: 'rgba(251,191,36,0.12)',  color: '#FBBF24', label: 'Separating' },
  departed:    { bg: 'rgba(245,142,154,0.12)', color: '#F58E9A', label: 'Departed' },
  archived:    { bg: 'rgba(255,255,255,0.06)', color: '#9ca3af', label: 'Archived' },
}
                ...
                <li key={person.id}>
                  ...
                  >
                    <div
                      ...
                      style={{ background: 'rgba(124,147,245,0.15)', color: ACCENT }}
                    >
