    ...
    <div>
      <form onSubmit={submit} className="flex gap-2">
        <input
          ...
          className="flex-1 bg-white/[0.04] border border-white/[0.06] rounded-xl px-4 py-2.5 text-sm text-white/90 placeholder-white/25 outline-none focus:border-[#38BDF8]/40 disabled:opacity-50"
        />
        <button
          type="submit"
