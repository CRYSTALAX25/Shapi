  ...
  return (
    <div className="min-h-screen bg-[#F1F2F7] flex items-center justify-center px-6">
      ...
      <div className="relative z-10 text-center max-w-sm">
        ...
        <p className="text-[#8A8A99] text-xs font-bold uppercase tracking-widest mb-3">404</p>
        <h1 className="text-3xl font-black text-[#0E0E1A] mb-3">Nothing here.</h1>
        <p className="text-[#3F3F4E] text-sm leading-relaxed mb-8">
