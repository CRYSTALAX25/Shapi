    ...
    <div className="min-h-screen bg-[#0E0E13] text-[#F4F4F7] overflow-x-hidden">
      <style>{`
        ...
        .tool-chip.collapsed {
          ...
          text-decoration-color: rgba(245,142,154,0.7);
        }
      `}</style>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-2 gap-5">
          ...
          >
            ...
            <p className="text-4xl font-black tracking-tighter mb-3" style={{ color: '#6AA8F5' }}>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 py-20">
        ...
        >
          ...
          />
          <div className="relative">
            <p className="text-[11px] font-black tracking-[0.25em] uppercase mb-5" style={{ color: '#A78BFA' }}>
