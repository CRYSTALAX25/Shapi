  ...
  return (
    <div className="min-h-screen text-[#F4F4F7]" style={{ background: '#0E0E13' }}>
      <style>{`
        ...
        .animated-gradient {
          background: linear-gradient(135deg, #9D8AD6, #5FB7C7, #E08494, #9D8AD6);
        ...
        .gradient-border-card {
          background: linear-gradient(#16161F, #16161F) padding-box,
                      linear-gradient(135deg, rgba(95,183,199,0.18), rgba(130,115,192,0.18)) border-box;
        ...
        .gradient-border-card:hover {
          background: linear-gradient(#16161F, #16161F) padding-box,
                      linear-gradient(135deg, rgba(95,183,199,0.5), rgba(130,115,192,0.5)) border-box;
          box-shadow: 0 1px 2px rgba(0,0,0,0.45), 0 16px 40px rgba(0,0,0,0.35);
        }
      `}</style>
          ...
          <>
            ...
            <div className="grid lg:grid-cols-2 gap-4 mb-5 items-stretch">
              ...
              <div className="rounded-2xl p-6 flex items-center gap-5"
                ...
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-widest mb-1" style={{ color: '#5FB7C7' }}>Shapi says</p>
                  <p className="text-[#F4F4F7] text-sm leading-relaxed font-medium">{shapiMessage}</p>
                </div>
                {!profile?.cv_parsed && (
                  <Link href="/upload-cv"
                    className="ml-auto flex-shrink-0 bg-gradient-to-r from-[#5FB7C7] to-[#9D8AD6] px-4 py-2 rounded-full text-xs font-black text-[#060609] hover:opacity-90 transition-opacity">
                    Start →
                  </Link>
                )}
              </div>
              ...
              <div className="gradient-border-card rounded-2xl p-6 flex flex-col justify-center">
                    ...
                    <svg className="w-20 h-20 -rotate-90" viewBox="0 0 80 80">
                      ...
                      <defs>
                        <linearGradient id="progGrad" x1="0%" y1="0%" x2="100%" y2="0%">
                          <stop offset="0%" stopColor="#5FB7C7" />
                          <stop offset="100%" stopColor="#9D8AD6" />
                        </linearGradient>
                      </defs>
                    </svg>
                ...
                <div className="mt-4 h-1 bg-white/[0.06] rounded-full overflow-hidden">
                  <div className="h-full rounded-full transition-all" style={{ width: `${completion}%`, background: 'linear-gradient(90deg, #5FB7C7, #9D8AD6)' }} />
                </div>
              </div>
            </div>
                ...
                <div className="mt-3 pt-3 border-t border-white/[0.08] space-y-3">
                  <div>
                    ...
                    <ul className="text-[#C7C7D1] text-xs leading-relaxed space-y-1.5 pl-1">
                      <li><span className="font-bold text-[#5FB7C7]">&quot;skip&quot;</span> / <span className="font-bold text-[#5FB7C7]">&quot;next&quot;</span> — move to the next question</li>
                      <li><span className="font-bold text-[#5FB7C7]">&quot;repeat that&quot;</span> — re-ask the previous question</li>
                      <li><span className="font-bold text-[#5FB7C7]">&quot;done&quot;</span> / <span className="font-bold text-[#5FB7C7]">&quot;pause&quot;</span> — finish or pause (your answers are saved)</li>
                      <li><span className="font-bold text-[#5FB7C7]">&quot;start over&quot;</span> — wipe + begin the main interview fresh</li>
                      <li><span className="font-bold text-[#5FB7C7]">&quot;I don&apos;t know&quot;</span> — totally fine, we&apos;ll move on</li>
                    </ul>
                  </div>
                  <div>
                    <p className="text-[#A6A6B4] text-[11px] font-bold uppercase tracking-wider mb-1.5">Anytime, just text</p>
                    <ul className="text-[#C7C7D1] text-xs leading-relaxed space-y-1.5 pl-1">
                      <li><span className="font-bold text-[#9D8AD6]">&quot;voice&quot;</span> — record a voice sample in each language you speak</li>
                      <li><span className="font-bold text-[#9D8AD6]">&quot;references&quot;</span> — see your reference requests + status</li>
                    </ul>
                  </div>
            ...
            <div className="mb-3 flex items-center gap-2">
              ...
              {isConcierge ? (
                <span className="text-xs font-bold px-2.5 py-0.5 rounded-full" style={{ background: 'rgba(227,181,86,0.18)', color: '#E3B556' }}>Active Concierge</span>
              ) : isActive ? (
                <span className="text-xs font-bold px-2.5 py-0.5 rounded-full" style={{ background: 'rgba(224,132,148,0.15)', color: '#E08494' }}>Shapi Active</span>
              ) : isRolesBoard ? (
                <span className="text-xs font-bold px-2.5 py-0.5 rounded-full" style={{ background: 'rgba(95,183,199,0.12)', color: '#5FB7C7' }}>Open Roles Board</span>
              ) : profile?.cv_tier === 'pro' ? (
                <span className="text-xs font-bold px-2.5 py-0.5 rounded-full" style={{ background: 'rgba(157,138,214,0.18)', color: '#9D8AD6' }}>CV Pro</span>
              ) : cvKitPurchased ? (
                <span className="text-xs font-bold px-2.5 py-0.5 rounded-full" style={{ background: 'rgba(157,138,214,0.12)', color: '#9D8AD6' }}>CV Kit</span>
              ) : (
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {profile?.cv_parsed ? (
                ...
                <Link href="/upload-cv" className="gradient-border-card rounded-2xl p-6 block hover:bg-white/[0.05]">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-xl bg-[#5FB7C7]/15 flex items-center justify-center flex-shrink-0">
                      <svg className="w-5 h-5 text-[#5FB7C7]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-0.5">
                        ...
                        <span className="text-[10px] font-bold bg-[#5FB7C7]/15 text[#5FB7C7] px-2 py-0.5 rounded-full">Start here →</span>
                      </div>
              ...
              {profile?.whatsapp_number ? (
                ...
                <div className="gradient-border-card rounded-2xl p-6 opacity-50">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-xl bg-[#9D8AD6]/15 flex items-center justify-center flex-shrink-0">
                      <svg className="w-5 h-5 text-[#9D8AD6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {!cvKitPurchased && profile?.cv_parsed && (
                <Link href="/pay" className="gradient-border-card rounded-2xl p-6 block hover:bg-white/[0.05] sm:col-span-2 lg:col-span-3" style={{
                  background: 'linear-gradient(#16161F,#16161F) padding-box, linear-gradient(135deg,rgba(157,138,214,0.3),rgba(95,183,199,0.2)) border-box',
                  border: '1px solid transparent',
                  ...
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-[10px] font-bold bg-[#9D8AD6]/15 text-[#9D8AD6] px-2 py-0.5 rounded-full">From $25 one-time</span>
                      </div>
                      <p className="text-[#7E7E8E] text-xs">English + native language version, industry-optimised, send to WhatsApp or email.</p>
                    </div>
                    <span className="text-[#9D8AD6] font-black text-sm flex-shrink-0">Unlock →</span>
                  </div>
                </Link>
              )}
              ...
              <Link href="/evidence" className="gradient-border-card rounded-2xl p-6 block hover:bg-white/[0.05]">
                <div className="flex items-center gap-4">
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${evidenceCount > 0 ? 'bg-emerald-500/15' : 'bg-[#E08494]/15'}`}>
                    {evidenceCount > 0 ? (
                      <svg className="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                    ) : (
                      <svg className="w-5 h-5 text-[#E08494]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      {evidenceCount > 0 ? (
                        ...
                        <span className="text-[10px] font-bold bg-[#E08494]/15 text-[#E08494] px-2 py-0.5 rounded-full">Add now</span>
                      )}
                    </div>
              ...
              {(() => {
                ...
                return (
                  <Link href="/profile/edit" className="gradient-border-card rounded-2xl p-6 block hover:bg-white/[0.05] transition-colors">
                    <div className="flex items-center gap-4">
                      <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${has ? 'bg-emerald-500/15' : 'bg-[#5FB7C7]/15'}`}>
                        {has ? (
                          <svg className="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                          </svg>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-0.5">
                          ...
                          {has
                            ...
                            : <span className="text-[10px] font-bold bg-[#5FB7C7]/15 text-[#5FB7C7] px-2 py-0.5 rounded-full">Add now</span>}
                        </div>
              ...
              <Link href="/upskill" className="gradient-border-card rounded-2xl p-6 block hover:bg-white/[0.05] transition-colors">
                <div className="flex items-center gap-4">
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${(coursesInProgress + coursesCompleted) > 0 ? 'bg-emerald-500/15' : 'bg-[#9D8AD6]/15'}`}>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      {(coursesInProgress + coursesCompleted) > 0
                        ...
                        : <span className="text-[10px] font-bold bg-[#9D8AD6]/15 text-[#9D8AD6] px-2 py-0.5 rounded-full">Browse</span>}
                    </div>
              ...
              <Link href="/work-style" className="gradient-border-card rounded-2xl p-6 block hover:bg-white/[0.05] transition-colors">
                <div className="flex items-center gap-4">
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${profile?.work_style ? 'bg-emerald-500/15' : 'bg-[#E08494]/15'}`}>
                    <span className="text-lg">🧭</span>
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      {profile?.work_style
                        ? <span className="text-[10px] font-bold bg-emerald-500/15 text-emerald-400 px-2 py-0.5 rounded-full">Done ✓</span>
                        : <span className="text-[10px] font-bold bg-[#E08494]/15 text-[#E08494] px-2 py-0.5 rounded-full">2 min</span>}
                    </div>
              ...
              <div className="sm:col-span-2 lg:col-span-3 rounded-2xl p-6" style={{
                background: 'linear-gradient(#16161F,#16161F) padding-box, linear-gradient(135deg,rgba(227,181,86,0.35),rgba(224,132,148,0.25)) border-box',
                border: '1px solid transparent',
                boxShadow: '0 1px 2px rgba(0,0,0,0.45), 0 16px 40px rgba(0,0,0,0.35)',
              }}>
                <div className="flex items-start justify-between gap-4 mb-4">
                  <div>
                    <p className="text-[#E3B556] text-xs font-bold uppercase tracking-wider mb-1">Concierge · today's shortlist</p>
                  ...
                  <form action="/api/concierge/scan" method="POST">
                    <button type="submit" className="text-[#E3B556] text-xs font-bold border border-[#E3B556]/30 hover:border-[#E3B556]/60 px-3 py-1.5 rounded-full transition-colors">
                      Refresh now
                    </button>
                  </form>
                </div>
                      ...
                      return (
                        <div key={draft.id} className="bg-white/[0.05] rounded-xl p-3 border border-white/[0.08]">
                          <div className="flex items-center justify-between mb-1">
                            ...
                            <span className="text-[#E3B556] text-xs font-black">{draft.match_score}%</span>
                          </div>
                          {draft.draft_subject && (
                          ...
                          <div className="flex items-center justify-between mt-2">
                            <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                              ...
                              draft.status === 'approved' ? 'bg-[#5FB7C7]/15 text-[#5FB7C7]' :
                              draft.status === 'auto_send' ? 'bg-[#E3B556]/15 text-[#E3B556]' :
              ...
              <div className={`gradient-border-card rounded-2xl p-6 sm:col-span-2 lg:col-span-3 ${shortlistedByCount === 0 ? 'opacity-50' : ''}`}>
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-5xl font-black" style={{ color: shortlistedByCount > 0 ? '#5FB7C7' : 'rgba(255,255,255,0.10)' }}>
                    {shortlistedByCount}
                  </div>
                </div>
              </div>
              ...
              <Link href="/roles" className="gradient-border-card rounded-2xl p-6 flex items-center justify-between hover:bg-white/[0.05] transition-all">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0"
                    style={{ background: 'linear-gradient(135deg, rgba(95,183,199,0.15), rgba(130,115,192,0.15))' }}>
                    <svg className="w-5 h-5 text-[#5FB7C7]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  {interestedRolesCount > 0 && (
                    <span className="text-xs font-bold px-2.5 py-1 rounded-full"
                      style={{ background: 'rgba(95,183,199,0.12)', color: '#5FB7C7' }}>
            ...
            <div className="mt-4">
              <Link href="/active" className="block rounded-2xl p-6 hover:opacity-90 transition-opacity"
                style={{
                  background: 'linear-gradient(135deg, rgba(224,132,148,0.12) 0%, rgba(130,115,192,0.12) 50%, rgba(95,183,199,0.12) 100%)',
                  border: '1px solid rgba(224,132,148,0.2)',
                }}>
                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-xs font-bold px-2.5 py-1 rounded-full"
                        style={{ background: 'rgba(224,132,148,0.2)', color: '#E08494' }}>
                        NEW
                      </span>
                  ...
                  <div className="flex flex-col items-end gap-1 flex-shrink-0 ml-4">
                    {activeApplicationsCount > 0 && (
                      <span className="text-2xl font-black" style={{ color: '#E08494' }}>{activeApplicationsCount}</span>
                    )}
                    {activeApplicationsCount > 0 && (
          ...
          <>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/company/onboarding" className="gradient-border-card rounded-2xl p-7 block hover:bg-white/[0.05]">
                <div className="w-11 h-11 rounded-xl bg-[#5FB7C7]/15 flex items-center justify-center mb-5">
                  <svg className="w-5 h-5 text-[#5FB7C7]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="/company/dashboard" className="gradient-border-card rounded-2xl p-7 block hover:bg-white/[0.05]">
                <div className="w-11 h-11 rounded-xl bg-[#9D8AD6]/15 flex items-center justify-center mb-5">
                  <svg className="w-5 h-5 text-[#9D8AD6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {profile?.subscription_status === 'active' ? (
                ...
                <Link href="/company/pricing" className="md:col-span-2 rounded-2xl p-7 block hover:opacity-90 transition-opacity" style={{
                  ...
                  border: '1px solid rgba(95,183,199,0.2)',
                }}>
                  <div className="flex items-center justify-between">
                    <div>
