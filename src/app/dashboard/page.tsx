            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-0.5">
                        ...
                        <span className="text-[10px] font-bold bg-[#6AA8F5]/15 text-[#6AA8F5] px-2 py-0.5 rounded-full">Start here →</span>
                      </div>
              ...
              {(() => {
                ...
                return (
                  <Link href="/profile/edit" className="gradient-border-card rounded-2xl p-6 block hover:bg-white/[0.05] transition-colors">
                    <div className="flex items-center gap-4">
                      <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${has ? 'bg-emerald-500/15' : 'bg-[#6AA8F5]/15'}`}>
                        {has ? (
                          <svg className="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                          </svg>
              ...
              <div className={`gradient-border-card rounded-2xl p-6 sm:col-span-2 lg:col-span-3 ${shortlistedByCount === 0 ? 'opacity-50' : ''}`}>
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-5xl font-black" style={{ color: shortlistedByCount > 0 ? '#6AA8F5' : 'rgba(255,255,255,0.10)' }}>
                    {shortlistedByCount}
                  </div>
                </div>
              </div>
