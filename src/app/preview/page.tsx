      ...
      <Screen>
        <div className="text-center max-w-sm">
          <div className="w-16 h-16 rounded-2xl mx-auto mb-6 flex items-center justify-center"
            style={{ background: 'linear-gradient(135deg, rgba(106,168,245,0.18), rgba(240,140,174,0.18))' }}>
            <div className="w-7 h-7 rounded-full border-2 border-[#6AA8F5] border-t-transparent animate-spin" />
          </div>
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-5 pt-8 pb-32">
        ...
        <div className="gradient-border-card rounded-2xl p-6 mt-6">
          ...
          <p className="text-center text-[11px] text-[#5C5C6A] mt-3">
            Already started?{' '}
            <Link href="/login" className="text-[#6AA8F5] hover:underline">Log in</Link>
          </p>
        </div>
      </div>
    </div>
...
function FadeOverlay() {
  return (
    <div className="absolute inset-0 flex items-end justify-center"
      style={{ background: 'linear-gradient(to bottom, rgba(14,14,19,0) 0%, rgba(14,14,19,0.6) 55%, #0E0E13 100%)' }}>
      <div className="mb-2">
...
function LockChip({ label }: { label: string }) {
  return (
    <span className="flex items-center gap-1.5 text-[11px] font-bold text-[#C7C7D1] bg-[#16161F]/90 border border-[rgba(255,255,255,0.1)] px-3 py-1.5 rounded-full">
      <svg className="w-3 h-3 text-[#6AA8F5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
