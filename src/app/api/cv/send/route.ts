    ...
    try {
      ...
      await getResend().emails.send({
        ...
        html: `<!doctype html><html><body style="background:#060609;font-family:system-ui;margin:0;padding:40px 24px">
          <div style="max-width:540px;margin:0 auto;background:#0d0d14;border:1px solid rgba(34,211,238,0.15);border-radius:16px;padding:32px;color:white">
            ...
            <p style="color:rgba(255,255,255,0.45);font-size:13px;line-height:1.6;margin:0">Open the attachment to view + share with hiring managers. You can re-generate or download any other versions anytime at <a href="${SITE}/cv-ready" style="color:#22D3EE">shapi.io/cv-ready</a>.</p>
