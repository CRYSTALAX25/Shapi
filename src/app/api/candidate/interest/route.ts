  ...
  return `
    <div style="font-family:-apple-system,sans-serif;max-width:520px;margin:0 auto;padding:32px 20px;background:#060609">
      ...
      <div style="background:#0D0C14;border:1px solid rgba(56, 189, 248, 0.2);border-radius:16px;padding:28px">
        ...
        <a href="${SITE}/${perspective === 'candidate' ? 'roles' : 'company/dashboard'}" style="display:inline-block;padding:13px 26px;background:linear-gradient(135deg,#38BDF8, #34D399);color:#060609;font-size:14px;font-weight:900;border-radius:100px;text-decoration:none">
