...
// Hourly Vercel cron. Walks candidates through the 3-part welcome sequence:
...
// given stage is never double-sent even if the cron overlaps or retries.
...
export async function GET(request: Request) {
  ...
  return NextResponse.json({ sent, byStage })
}
