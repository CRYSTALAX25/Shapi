    ...
    <div className="min-h-screen bg-[#060609] flex items-center justify-center px-6">
      ...
      <div className="relative z-10 max-w-md w-full">
        <div className="text-center mb-10">
          <Link href="/" className="font-black text-2xl tracking-tighter" style={{ background: 'linear-gradient(135deg, #38BDF8, #34D399)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>shapi</Link>
        ...
        {recoverable === false && !done && (
          <div className="rounded-2xl p-5 text-center" style={{ background: 'rgba(251, 113, 133, 0.10)', border: '1px solid rgba(251, 113, 133, 0.30)' }}>
            ...
            <Link href="/reset-password" className="inline-block px-5 py-2.5 rounded-full font-black text-xs text-white" style={{ background: 'linear-gradient(135deg,#38BDF8, #34D399)' }}>
              Send a new link →
            </Link>
          </div>
        )}
        ...
        {recoverable !== false && !done && (
          <form onSubmit={submit} className="space-y-3">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-[#38BDF8] to-[#38BDF8] py-4 rounded-full font-black text-sm text-white hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed mt-2"
            >
