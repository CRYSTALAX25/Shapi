...
// flow. Candidate-side palette (#0E0E13 bg, #6AA8F5→#F08CAE gradient), same
...
export default function ConfirmSeatClient({ token, initial }: Props) {
  ...
  return (
    <Shell>
      <span className="text-[#6AA8F5] text-xs font-bold uppercase tracking-wider">Role confirmation</span>
      ...
      {/* Seat card */}
      <div style={{
        background: 'linear-gradient(#16161F,#16161F) padding-box,linear-gradient(135deg,rgba(106,168,245,0.25),rgba(240,140,174,0.25)) border-box',
      ...
      {error && (
        <p className="text-sm mb-4 px-4 py-3 rounded-xl" style={{ color: '#F58E9A', background: 'rgba(245,142,154,0.08)', border: '1px solid rgba(245,142,154,0.25)' }}>
          {error}
        </p>
      )}
