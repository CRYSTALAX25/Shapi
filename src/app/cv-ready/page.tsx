  ...
  return (
    <div className="min-h-screen bg-[#060609] flex items-center justify-center px-6">
      ...
      <div className="relative z-10 max-w-md w-full text-center">
        ...
        <h1 className="text-3xl font-black text-white mb-3">Your CV is ready.</h1>
        <p className="text-white/50 text-sm leading-relaxed mb-8">
          Your Shapi CV kit is unlocked — download your English CV or your native language version below.
        </p>
        ...
        <div className="gradient-border-card rounded-2xl p-6 mb-6 text-left space-y-3">
          <a href="/profile/print" target="_blank"
            ...
            <div>
              ...
              <p className="text-white/40 text-xs">Professional, clean format</p>
            </div>
          ...
          <a href="/profile/print?lang=native" target="_blank"
            ...
            <div>
              ...
              <p className="text-white/40 text-xs">Auto-translated to your language</p>
            </div>
        ...
        <div className="gradient-border-card rounded-2xl p-5 mb-6 text-left">
          ...
          <div className="flex items-center gap-2 mt-2">
            <code className="text-[#22D3EE] text-xs bg-white/[0.05] px-3 py-1.5 rounded-lg flex-1 overflow-hidden text-ellipsis">
              shapi.io/p/{user.id.slice(0, 8)}
            </code>
            <button className="text-white/40 text-xs hover:text-white/70 px-3 py-1.5 bg-white/[0.05] rounded-lg">
              Copy
            </button>
          </div>
        </div>
