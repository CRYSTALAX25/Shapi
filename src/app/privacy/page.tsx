      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 py-12 prose-shapi">
        ...
        <div className="space-y-8 text-[#C7C7D1] text-sm leading-relaxed">
          ...
          <Section title="1. Who we are">
            ...
            <a href="mailto:hello@shapi.io" className="text-[#38BDF8]">hello@shapi.io</a>. We are the data
          ...
          <Section title="8. Data retention">
            ...
            <a href="mailto:hello@shapi.io" className="text-[#38BDF8]">hello@shapi.io</a>. Some records may be
          ...
          <Section title="9. Your rights">
            ...
            <a href="mailto:hello@shapi.io" className="text-[#38BDF8]">hello@shapi.io</a>. You can also unsubscribe
          ...
          <Section title="13. Contact">
            Questions or requests: <a href="mailto:hello@shapi.io" className="text-[#38BDF8]">hello@shapi.io</a>.
          </Section>
        </div>
