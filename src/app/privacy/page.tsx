      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 py-12 prose-shapi">
        ...
        <div className="space-y-8 text-white/60 text-sm leading-relaxed">
          ...
          <Section title="1. Who we are">
            ...
            <a href="mailto:hello@shapi.io" className="text-[#22D3EE]">hello@shapi.io</a>. We are the data
            controller for the personal data described below.
          </Section>

          <Section title="2. Data we collect">
            <ul className="list-disc pl-5 space-y-1.5 mt-2">
              <li><strong className="text-white/80">Account data</strong> — email address and password (stored hashed).</li>
              <li><strong className="text-white/80">Profile data</strong> — your CV, work history, skills, summary, headline, location, languages, profile photo, online-presence links, and right-to-work declarations.</li>
              <li><strong className="text-white/80">Conversation data</strong> — messages you exchange with Shapi (web and WhatsApp) and any voice notes you record, which we transcribe.</li>
              <li><strong className="text-white/80">Reference data</strong> — the names and contact details of referees you nominate, and the responses those referees provide about you.</li>
              <li><strong className="text-white/80">Payment data</strong> — handled by our payment processor (Stripe). We do not store your card number.</li>
              <li><strong className="text-white/80">Usage data</strong> — basic technical logs needed to run and secure the service.</li>
              <li><strong className="text-white/80">Marketing preferences</strong> — whether you have opted in to product and job-market emails, and how you heard about us.</li>
            </ul>
          </Section>
          ...
          <Section title="6. Service providers (processors)">
            ...
            <ul className="list-disc pl-5 space-y-1.5 mt-2">
              <li><strong className="text-white/80">Supabase</strong> — database, authentication, file storage.</li>
              ...
              <li><strong className="text-white/80">Resend</strong> — transactional and (opt-in) marketing email.</li>
              <li><strong className="text-white/80">Twilio</strong> — WhatsApp messaging.</li>
              <li><strong className="text-white/80">OpenAI / Deepgram</strong> — voice transcription.</li>
              <li><strong className="text-white/80">Anthropic</strong> — AI conversation, drafting, and cross-checking.</li>
            </ul>
          ...
          <Section title="8. Data retention">
            ...
            <a href="mailto:hello@shapi.io" className="text-[#22D3EE]">hello@shapi.io</a>. Some records may be
          ...
          <Section title="9. Your rights">
            ...
            <a href="mailto:hello@shapi.io" className="text-[#22D3EE]">hello@shapi.io</a>. You can also unsubscribe
          ...
          <Section title="13. Contact">
            Questions or requests: <a href="mailto:hello@shapi.io" className="text-[#22D3EE]">hello@shapi.io</a>.
          </Section>
        </div>
