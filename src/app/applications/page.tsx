      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 pt-8 pb-20">
        ...
        {apps.length === 0 ? (
          <div className="bg-[#0D0C14] rounded-2xl p-10 text-center" style={{ border: '1px solid rgba(255,255,255,0.08)' }}>
            ...
            <Link href="/roles" className="inline-block text-white text-sm font-bold px-5 py-2.5 rounded-full" style={{ background: 'linear-gradient(135deg,#38BDF8, #34D399)' }}>Browse roles →</Link>
          </div>
        ) : (
