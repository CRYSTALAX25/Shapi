...
const STAGE_COLORS: Record<string, string> = {
  researching: 'rgba(56, 189, 248, 0.15)',
  outreach_sent: 'rgba(56, 189, 248, 0.15)',
  interview: 'rgba(56, 189, 248, 0.15)',
  offer: 'rgba(56, 189, 248, 0.15)',
...
export default function ActivePage() {
  ...
  const matchColor = (score: number) =>
    score >= 70 ? '#38BDF8' : score >= 50 ? '#38BDF8' : '#38BDF8'
  ...
  return (
    <div className="min-h-screen bg-[#060609]">
      <style>{`
        ...
        .tab-active {
          background: linear-gradient(135deg, rgba(56, 189, 248, 0.12), rgba(56, 189, 248, 0.12));
                  ...
                  <div key={i} className="gradient-border-card card-hover rounded-2xl p-5 transition-all">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <button
                        ...
                        style={{
                          background: draftJob?.url === job.url && draft ? 'rgba(56, 189, 248, 0.15)' : 'rgba(255,255,255,0.05)',
                          border: draftJob?.url === job.url && draft ? '1px solid rgba(56, 189, 248, 0.3)' : '1px solid rgba(255,255,255,0.08)',
                          color: draftJob?.url === job.url && draft ? '#38BDF8' : '#A6A6B4',
                        }}
                      >
                    ...
                    {draftJob?.url === job.url && draft && (
                      <div className="mt-4 rounded-xl p-4" style={{ background: 'rgba(56, 189, 248, 0.06)', border: '1px solid rgba(56, 189, 248, 0.15)' }}>
                        {draft.subject && (
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                style={{
                  background: addingApp ? 'rgba(56, 189, 248, 0.15)' : 'rgba(255,255,255,0.05)',
                  border: addingApp ? '1px solid rgba(56, 189, 248, 0.3)' : '1px solid rgba(255,255,255,0.08)',
                  color: addingApp ? '#38BDF8' : '#A6A6B4',
                }}
              >
          ...
          <div className="space-y-4">
            ...
            {prepping && (
              <div className="gradient-border-card rounded-2xl p-12 text-center">
                <div className="flex justify-center mb-6">
                  <svg className="animate-spin w-8 h-8 text-[#38BDF8]" fill="none" viewBox="0 0 24 24">
                    <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
                    <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
                  </svg>
                </div>
            ...
            {prep && prepApp && !prepping && (
              <div className="space-y-4">
                ...
                {prepSection === 'snapshot' && prep.company_snapshot && (
                  <div className="space-y-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      <div className="gradient-border-card rounded-2xl p-5">
                        <h3 className="text-[#38BDF8] text-xs font-bold uppercase tracking-wider mb-3">Recent news</h3>
                      ...
                      <div className="gradient-border-card rounded-2xl p-5">
                        <h3 className="text-[#38BDF8] text-xs font-bold uppercase tracking-wider mb-3">Culture</h3>
                        <ul className="space-y-2">
                    ...
                    {prep.why_they_will_love_you?.length > 0 && (
                      <div className="gradient-border-card rounded-2xl p-6">
                        <h3 className="text-[#38BDF8] text-xs font-bold uppercase tracking-wider mb-3">Why they&apos;ll want you</h3>
                        <ul className="space-y-3">
                          {prep.why_they_will_love_you.map((r, i) => (
                            <li key={i} className="flex gap-3">
                              <span className="text-[#38BDF8] font-black flex-shrink-0">0{i + 1}</span>
                  ...
                  <div className="space-y-4">
                    ...
                    {prep.social_intel?.conversation_starters?.length > 0 && (
                      <div className="rounded-2xl p-6"
                        style={{ background: 'linear-gradient(135deg, rgba(56, 189, 248, 0.08), rgba(56, 189, 248, 0.08))', border: '1px solid rgba(56, 189, 248, 0.2)' }}>
                        <h3 className="text-[#38BDF8] text-xs font-bold uppercase tracking-wider mb-4">
                          💬 Use these in the interview
                        </h3>
                        <ul className="space-y-3">
                          {prep.social_intel.conversation_starters.map((s, i) => (
                            <li key={i} className="flex gap-3">
                              <span className="text-[#38BDF8] font-black flex-shrink-0 text-sm">→</span>
                    ...
                    {prep.social_intel?.leadership_voice && (
                      <div className="gradient-border-card rounded-2xl p-5">
                        <h3 className="text-[#38BDF8] text-xs font-bold uppercase tracking-wider mb-2">
                      ...
                      <div className="space-y-3">
                        ...
                        {prep.social_intel.linkedin_posts.map((post, i) => (
                          <div key={i} className="gradient-border-card rounded-xl p-5">
                            ...
                            {post.how_to_use && (
                              <div className="rounded-lg p-3" style={{ background: 'rgba(56, 189, 248, 0.06)', border: '1px solid rgba(56, 189, 248, 0.1)' }}>
                                <p className="text-[#38BDF8] text-[10px] font-bold uppercase tracking-wider mb-1">How to use this</p>
                    ...
                    {prep.social_intel?.social_themes?.length > 0 && (
                      <div className="gradient-border-card rounded-2xl p-5">
                        <h3 className="text-[#38BDF8] text-xs font-bold uppercase tracking-wider mb-3">Recurring themes across their social</h3>
                        <div className="flex flex-wrap gap-2">
                  ...
                  <div className="space-y-4">
                    {prep.your_stories.map((story, i) => (
                      <div key={i} className="gradient-border-card rounded-2xl p-6">
                        <p className="text-[#7E7E8E] text-xs font-bold mb-3">Use for: <span className="text-[#38BDF8]">&quot;{story.use_for_question}&quot;</span></p>
                        <div className="grid md:grid-cols-2 gap-4">
                          {[
                            { label: 'S — Situation', content: story.situation, color: '#38BDF8' },
                            { label: 'T — Task', content: story.task, color: '#38BDF8' },
                            { label: 'A — Action', content: story.action, color: '#38BDF8' },
                            { label: 'R — Result', content: story.result, color: '#38BDF8' },
                  ...
                  <div className="space-y-4">
                    {prep.likely_questions.map((q, i) => (
                      <div key={i} className="gradient-border-card rounded-2xl p-6">
                        ...
                        <div className="space-y-3">
                          <div>
                            <p className="text-[#38BDF8] text-xs font-bold mb-1">Your angle</p>
                  ...
                  <div className="gradient-border-card rounded-2xl p-6">
                    ...
                    <ul className="space-y-4">
                      {prep.questions_to_ask_them?.map((q, i) => (
                        <li key={i} className="flex gap-3">
                          <span className="text-[#38BDF8] font-black flex-shrink-0">Q{i + 1}</span>
                ...
                {prepSection === 'salary' && (
                  <div className="gradient-border-card rounded-2xl p-6">
                    <h3 className="text-[#38BDF8] text-xs font-bold uppercase tracking-wider mb-4">Salary intelligence</h3>
